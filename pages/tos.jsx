...
const TOS = () => (
	<Wrapper style={{ marginTop: '8em' }}>
		<h2>
			Terms of Service of
			{' '}
			<span className="website_url">https://www.sanysidrosda.com/</span>
		</h2>

		<p>
			<span className="website_name">San Ysidro SDA Church</span>
			{' '}
			("Us" or "We") provides the
			{' '}
			<span className="website_url">https://www.sanysidrosda.com/</span>
			{' '}
			website and various related services (collectively, the "Website") to you, the User, subject to your compliance with all the terms, conditions, and notices contained or referenced herein (the "Terms of Service"), as well as any other written agreement between us and you.
		</p>
		...
		<p>
			...
			. We expressly reserve the right to change these Terms of Service from time to time without notice to you. You acknowledge and agree that it is your responsibility to review this Website and these Terms of Service from time to time and to familiarize yourself with any modifications.
		</p>

		<p>
			Your continued use of this Website after such modifications will constitute acknowledgement of the modified Terms of Service and agreement to abide and be bound by the modified Terms of Service. This Terms of Service was created by
			{' '}
			<a href="https://www.termsservicetemplate.com">Terms of Service Template</a>
			{' '}
			and the
			{' '}
		...
		<p>
			All custom graphics, icons, logos, and service names used on the Website are registered trademarks, service marks, and/or artwork held under copyright of
			{' '}
			<span className="website_name">San Ysidro SDA Church</span>
			{' '}
			or its Affiliates. All other marks are property of their respective owners. Nothing in these Terms of Service grants you any right to use any trademark, service mark, logo, and/or the name or trade names of
			{' '}
			<span className="website_name">San Ysidro SDA Church</span>
			{' '}
			or its Affiliates.
		...
		<p>
			...
			<span className="website_name">San Ysidro SDA Church</span>
			{' '}
			spokesperson speaking in his/her official capacity. Please refer to the specific editorial policies posted on various sections of this Website for further information, which policies are incorporated by reference into these Terms of Service.
		</p>
		...
		<p>
			These Terms of Service and any dispute or claim arising out of, or related to them, shall be governed by and construed in accordance with the internal laws of the
			{' '}
		...
		<p>
			Any legal suit, action or proceeding arising out of, or related to, these Terms of Service or the Website shall be instituted exclusively in the federal courts of
			{' '}
			<span className="country">us</span>
			.
		</p>
